    ...
    <YStack f={1} bg="$background" p="$4">
      <YStack mb="$6">
        ...
        <YStack bg="$gray4" br={16} p="$4" ai="center">
          <Text color="$gray10" fontSize={14} fontFamily="$mono" fontWeight="500" mb="$1">
            Last 7 days, you spent
          </Text>
          <Text color="$color" fontFamily="$mono" fontSize={24} fontWeight="bold">
      ...
      {activeTab === 'sessions' ? (
        ...
        <YStack f={1}>
          <XStack jc="space-between" ai="center" mb="$4">
            <Text color="$color" fontFamily="$mono" fontSize={18} fontWeight="600">
              Subject Breakdown
            </Text>
